...
[![Version](https://img.shields.io/badge/version-2.1.0-blue.svg)](https://github.com/anaboeriu14/adRutils/releases)
[![Coverage](https://img.shields.io/badge/coverage-67%25-yellow?)](https://github.com/anaboeriu14/adRutils/blob/main/NEWS.md)

A collection of R utility functions for data cleaning, transformation,
file operations, ID mapping, and statistical modeling. Designed to
streamline data workflows and improve reproducibility.

> **Version 2.0.0 is a major cleanup release.** Several functions and
> parameters have been renamed for clarity and consistency. See
...
The [adRutils package website](https://anaboeriu14.github.io/adRutils/)
has full reference documentation, articles, and the changelog.
...
[GitHub](https://github.com/anaboeriu14/adRutils/issues).
